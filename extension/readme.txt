...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\evendeeper on
     Windows, /home/user/dev/evendeeper on Linux) in a file named
     evendeeper@james.salter and copy that file to
