...
cat shared/even_deeper.js shared/nlp.js shared/jquery-132min.js shared/article.js shared/google_reader_shared.js shared/article_extractor.js shared/html_parser.js shared/similarity.js bookmarklet/bookmarklet.js bookmarklet/bookmarklet_ui.js bookmarklet/bookmarklet_page_controller.js >> tmp/evendeeper_bookmarklet.js
